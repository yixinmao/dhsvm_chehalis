...
################# user defined ################
result_path_1 = '/usr1/ymao/dhsvm_chehalis/result_analyis/model_results/results_v2.1_20140529'
result_path_2 = '/usr1/ymao/dhsvm_chehalis/result_analyis/model_results/results_v3.1.2_20140529'
label1 = 'v2.1'
label2 = 'v3.1.2'
output_path = '/usr1/ymao/dhsvm_chehalis/result_analyis/output/compare_v2.1_v3.1.2_20140529'
stream_gauge_path = '/usr1/ymao/dhsvm_chehalis/result_analyis/stream_gauge_data/recent_gauge_daily_data_2006_2011'
start_time = dt.datetime(year=2006, month=1, day=1, hour=0)
end_time = dt.datetime(year=2011, month=12, day=31, hour=21)
dtime = 3  # hours

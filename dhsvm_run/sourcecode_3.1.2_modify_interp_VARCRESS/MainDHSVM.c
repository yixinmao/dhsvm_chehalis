...
////////////////////////// hacked by Yixin /////////////////////////////
  uchar ***WeightStn = NULL;	/* 3D array recording the nearest few stations to use in VARCRESS interpolation */
////////////////////////////////////////////////////////////////////////
...
/////////////////////////////// hacked by Yixin ////////////////////////////////////
  InitInterpolationWeights(&Map, &Options, TopoMap, &MetWeights, &WeightStn, Stat, NStats);
////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////// hacked by Yixin /////////////////////////////
		  if (Options.Shading)
	        ...
	        MakeLocalMetData(y, x, &Map, Time.DayStep, &Options, NStats,
			       Stat, MetWeights[y][x], WeightStn[y][x], TopoMap[y][x].Dem,
